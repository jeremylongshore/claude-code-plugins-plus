...
- **`governed-second-brain` now completes a real MCP initialize handshake from a cold
  ...
  provisioning and fail before the initialize response. Its install guide and plugin manifest now
  also describe all three lockfile-pinned native modules accurately. ([#1195](https://github.com/jeremylongshore/claude-code-plugins-plus-skills/pull/1195))
