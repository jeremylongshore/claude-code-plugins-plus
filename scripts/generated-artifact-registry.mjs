...
export const GENERATED_ARTIFACT_REGISTRY = [
  ...
  },
  {
    ...
    regenerate: 'node marketplace/scripts/discover-skills.mjs',
    postprocess: 'pnpm run normalize:dead-domain-projections',
    contentCheck: false,
    followup:
      'regeneration currently expands the public catalog by 60 skills and requires a separately reviewed baseline update',
    why: 'deterministic L1 skill projection used by the website and Freshie consumers; baseline update remains in E1.8',
  },
  {
    ...
    canonical: '.claude-plugin/marketplace.extended.json and plugin SKILL.md sources',
    regenerate: 'node marketplace/scripts/discover-skills.mjs --level=metadata --check',
    postprocess: 'pnpm run normalize:dead-domain-projections',
    contentCheck: true,
