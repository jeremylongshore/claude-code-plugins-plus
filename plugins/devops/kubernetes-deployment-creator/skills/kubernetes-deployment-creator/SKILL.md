---
description: This skill enables claude to generate kubernetes deployment manifests,
  services, and related configurations following best practices. it should be used
  when the user asks to create a new kubernetes deployment, service, ingress, or other
  related re...
allowed-tools:
- Read
- Write
