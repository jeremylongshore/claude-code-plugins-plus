...
- A lint/format command (recommended) and a clear CI-style “quality gate”
...
2. Define the overnight task as a testable goal (what to build/fix, what “done” means, and which commands must pass).
