...
description: Use when the user shares ad campaign performance data and asks what to cut, scale, or test. Trigger phrases include "analyze my ad campaigns", "where am I wasting ad spend", "reallocate my ad budget", "which ads are actually working", "ROAS analysis", or "optimize my Meta/Google Ads spend". Ingests campaign exports (CSV, paste, or screenshot from Google, Meta, LinkedIn), runs statistical-significance checks and funnel diagnostics, and outputs budget-waste analysis, winners to scale, and a multi-channel budget reallocation plan with dollar-amount shifts. Do NOT trigger for campaign planning or ad creative generation without performance data.
version: 1.0.0
author: GooseWorks <himanshu@athina.ai>
license: MIT
compatibility: Pure reasoning skill over user-provided campaign exports — no external tools, network calls, or API keys.
tags: [community, marketing, ads, analytics, budget-optimization]
---
