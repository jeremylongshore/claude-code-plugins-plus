---
name: salesloft-contact-sync
description: |
  Execute Salesloft primary workflow: Contact Sync & Enrichment.
  ...
  Trigger with phrases like "salesloft sync contacts",
  "import and enrich contacts with salesloft".
...
# Salesloft Contact Sync & Enrichment
...
- Access to contacts/deals data in your Salesloft instance
...
## Next Steps
For secondary workflow, see `salesloft-deal-pipeline`.