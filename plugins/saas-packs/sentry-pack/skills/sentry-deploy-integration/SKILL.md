...
description: |
  Deploy Sentry integrations to production platforms.
  Use when deploying Sentry-powered applications to production,
  configuring platform-specific secrets, or setting up deployment pipelines.
  Trigger with phrases like "deploy sentry", "sentry production",
  "sentry production deploy", "sentry CI/CD".
...
Deploy Sentry as a sidecar agent alongside your application, plus webhook
