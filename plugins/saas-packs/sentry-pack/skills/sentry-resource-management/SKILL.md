---
name: sentry-resource-management
description: |
  Execute Sentry secondary workflow: Resource Management.
  Use when provisioning GPU instances for ML workloads,
  or auto-scaling infrastructure based on demand.
  Trigger with phrases like "sentry manage resources",
  "provision infrastructure with sentry".
...
- Familiarity with `sentry-monitor-alert`
...
## Next Steps
For common errors, see `sentry-common-errors`.