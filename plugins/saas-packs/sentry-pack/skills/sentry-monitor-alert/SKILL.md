---
name: sentry-monitor-alert
description: |
  Execute Sentry primary workflow: Monitor & Alert.
  ...
  Trigger with phrases like "sentry monitor",
...
## Next Steps
For secondary workflow, see `sentry-resource-management`.