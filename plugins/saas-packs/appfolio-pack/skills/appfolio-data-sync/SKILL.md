---
name: appfolio-data-sync
description: |
  Execute AppFolio secondary workflow: Integration & Data Sync.
  Use when syncing records between systems on a schedule,
  or building real-time event-driven integrations.
  Trigger with phrases like "appfolio sync data",
  "sync between systems with appfolio".
...
# AppFolio Integration & Data Sync
...
- Familiarity with `appfolio-entity-management`
