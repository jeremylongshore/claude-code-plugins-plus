---
name: appfolio-entity-management
description: |
  Execute AppFolio primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "appfolio manage entities",
  "create or update domain entities with appfolio".
...
# AppFolio Domain Entity Management
...
## Next Steps
For secondary workflow, see `appfolio-data-sync`.