---
name: podium-campaign-delivery
description: |
  Execute Podium primary workflow: Campaign & Message Delivery.
  ...
  Trigger with phrases like "podium send campaign",
  "create and send campaign with podium".
...
# Podium Campaign & Message Delivery
...
## Next Steps
For secondary workflow, see `podium-event-tracking`.