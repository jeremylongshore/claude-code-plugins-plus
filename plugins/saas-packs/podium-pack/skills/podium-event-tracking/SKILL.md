---
name: podium-event-tracking
description: |
  Execute Podium secondary workflow: Event Tracking & Segmentation.
  Use when tracking product usage events to trigger messages,
  or building behavioral segments for campaign targeting.
  Trigger with phrases like "podium track events",
  "track user events with podium".
...
# Podium Event Tracking & Segmentation
...
- Familiarity with `podium-campaign-delivery`
