---
name: abridge-model-inference
description: |
  Execute Abridge primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "abridge inference",
  "run model inference with abridge".
...
# Abridge Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `abridge-embeddings-search`.