---
name: customerio-campaign-delivery
description: |
  Execute Customer.io primary workflow: Campaign & Message Delivery.
  ...
  Trigger with phrases like "customerio send campaign",
  "create and send campaign with customerio".
...
# Customer.io Campaign & Message Delivery
...
- Understanding of Customer.io core concepts
...
- Expected results from Customer.io API
...
## Next Steps
For secondary workflow, see `customerio-event-tracking`.