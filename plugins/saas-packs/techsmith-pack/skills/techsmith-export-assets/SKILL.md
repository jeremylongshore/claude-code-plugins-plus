---
name: techsmith-export-assets
description: |
  Execute TechSmith primary workflow: Export & Asset Pipeline.
  ...
  Trigger with phrases like "techsmith export assets",
  "export design assets with techsmith".
...
# TechSmith Export & Asset Pipeline
...
## Next Steps
For secondary workflow, see `techsmith-design-token-sync`.