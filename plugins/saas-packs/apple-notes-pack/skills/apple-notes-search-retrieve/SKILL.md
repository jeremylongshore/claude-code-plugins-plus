---
name: apple-notes-search-retrieve
description: |
  Execute Apple Notes secondary workflow: Search & Knowledge Retrieval.
  Use when finding relevant pages by keyword or tag,
  or building a knowledge base search for internal tools.
  Trigger with phrases like "apple-notes search",
  "search content with apple-notes".
...
# Apple Notes Search & Knowledge Retrieval
...
- Familiarity with `apple-notes-content-management`
