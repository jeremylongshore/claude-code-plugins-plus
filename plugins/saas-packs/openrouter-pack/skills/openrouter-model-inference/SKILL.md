---
name: openrouter-model-inference
description: |
  Execute OpenRouter primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "openrouter inference",
  "run model inference with openrouter".
...
# OpenRouter Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `openrouter-embeddings-search`.