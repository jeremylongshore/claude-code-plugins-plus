...
description: |
  Upgrade OpenRouter integrations and migrate between versions. Triggers on "openrouter upgrade",
  "openrouter migration", "update openrouter", "openrouter new version".
