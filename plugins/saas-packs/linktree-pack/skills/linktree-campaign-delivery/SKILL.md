---
name: linktree-campaign-delivery
description: |
  Execute Linktree primary workflow: Campaign & Message Delivery.
  ...
  Trigger with phrases like "linktree send campaign",
  "create and send campaign with linktree".
...
# Linktree Campaign & Message Delivery
...
## Next Steps
For secondary workflow, see `linktree-event-tracking`.