---
name: linktree-event-tracking
description: |
  Execute Linktree secondary workflow: Event Tracking & Segmentation.
  Use when tracking product usage events to trigger messages,
  or building behavioral segments for campaign targeting.
  Trigger with phrases like "linktree track events",
  "track user events with linktree".
...
# Linktree Event Tracking & Segmentation
...
- Familiarity with `linktree-campaign-delivery`
