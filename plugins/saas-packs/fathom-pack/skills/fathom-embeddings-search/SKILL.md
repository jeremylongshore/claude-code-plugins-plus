---
name: fathom-embeddings-search
description: |
  Execute Fathom secondary workflow: Embeddings & Semantic Search.
  Use when building a RAG pipeline over documents,
  or semantic similarity search across content.
  Trigger with phrases like "fathom embeddings",
  "generate embeddings with fathom".
...
# Fathom Embeddings & Semantic Search
...
- Familiarity with `fathom-model-inference`
