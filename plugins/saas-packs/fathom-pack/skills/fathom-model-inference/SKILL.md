---
name: fathom-model-inference
description: |
  Execute Fathom primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "fathom inference",
  "run model inference with fathom".
...
# Fathom Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `fathom-embeddings-search`.