---
name: persona-data-sync
description: |
  Execute Persona secondary workflow: Integration & Data Sync.
  Use when syncing records between systems on a schedule,
  or building real-time event-driven integrations.
  Trigger with phrases like "persona sync data",
  "sync between systems with persona".
...
- Familiarity with `persona-entity-management`
