---
name: persona-entity-management
description: |
  Execute Persona primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "persona manage entities",
  "create or update domain entities with persona".
...
# Persona Domain Entity Management
...
## Next Steps
For secondary workflow, see `persona-data-sync`.