...
description: |
  Execute Navan primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "navan manage entities",
  "create or update domain entities with navan".
...
# Navan Domain Entity Management
...
## Next Steps
For secondary workflow, see `navan-data-sync`.