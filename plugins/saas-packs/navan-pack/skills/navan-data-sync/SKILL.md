...
description: |
  Execute Navan secondary workflow: Integration & Data Sync.
  Use when syncing records between systems on a schedule,
  or building real-time event-driven integrations.
  Trigger with phrases like "navan sync data",
  "sync between systems with navan".
...
- Familiarity with `navan-entity-management`
