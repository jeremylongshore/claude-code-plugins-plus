---
name: algolia-query-transform
description: |
  Execute Algolia primary workflow: Query & Transform Data.
  ...
  Trigger with phrases like "algolia query data",
  "run analytical query with algolia".
...
## Next Steps
For secondary workflow, see `algolia-schema-migration`.