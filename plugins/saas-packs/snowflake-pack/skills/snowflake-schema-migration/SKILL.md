---
name: snowflake-schema-migration
description: |
  Execute Snowflake secondary workflow: Schema Migration & Data Modeling.
  Use when creating tables and indexes for a new feature,
  or altering columns without downtime.
  Trigger with phrases like "snowflake migration",
  "run schema migration with snowflake".
...
# Snowflake Schema Migration & Data Modeling
...
- Familiarity with `snowflake-query-transform`
