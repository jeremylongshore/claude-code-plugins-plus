---
name: snowflake-query-transform
description: |
  Execute Snowflake primary workflow: Query & Transform Data.
  ...
  Trigger with phrases like "snowflake query data",
  "run analytical query with snowflake".
...
# Snowflake Query & Transform Data
...
## Next Steps
For secondary workflow, see `snowflake-schema-migration`.