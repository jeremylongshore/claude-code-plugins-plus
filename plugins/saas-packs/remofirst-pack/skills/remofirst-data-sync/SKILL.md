---
name: remofirst-data-sync
description: |
  Execute RemoFirst secondary workflow: Integration & Data Sync.
  Use when syncing records between systems on a schedule,
  or building real-time event-driven integrations.
  Trigger with phrases like "remofirst sync data",
  "sync between systems with remofirst".
...
# RemoFirst Integration & Data Sync
...
- Familiarity with `remofirst-entity-management`
