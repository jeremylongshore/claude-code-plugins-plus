---
name: remofirst-entity-management
description: |
  Execute RemoFirst primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "remofirst manage entities",
  "create or update domain entities with remofirst".
...
# RemoFirst Domain Entity Management
...
## Next Steps
For secondary workflow, see `remofirst-data-sync`.