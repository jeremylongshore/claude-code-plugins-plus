---
name: posthog-schema-migration
description: |
  Execute PostHog secondary workflow: Schema Migration & Data Modeling.
  Use when creating tables and indexes for a new feature,
  or altering columns without downtime.
  Trigger with phrases like "posthog migration",
  "run schema migration with posthog".
...
# PostHog Schema Migration & Data Modeling
...
- Familiarity with `posthog-query-transform`
