---
name: grammarly-embeddings-search
description: |
  Execute Grammarly secondary workflow: Embeddings & Semantic Search.
  Use when building a RAG pipeline over documents,
  or semantic similarity search across content.
  Trigger with phrases like "grammarly embeddings",
  "generate embeddings with grammarly".
...
# Grammarly Embeddings & Semantic Search
...
- Familiarity with `grammarly-model-inference`
