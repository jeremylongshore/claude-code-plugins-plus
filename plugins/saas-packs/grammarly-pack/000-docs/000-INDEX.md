# Grammarly pack design records

| ID | Type | Document | Status |
|---|---|---|---|
| 001 | BL-LICN | [License](001-BL-LICN-license.txt) | Active |
| 002 | RL-RSRC | [Official API contract audit](002-RL-RSRC-grammarly-api-contract-audit.md) | Verified 2026-09-04 |
...
These records explain why v2 removes the old 24-skill tutorial surface and how the
five production workflows are validated. Runtime instructions remain in each skill.
