---
name: fireflies-model-inference
description: |
  Execute Fireflies.ai primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "fireflies inference",
  "run model inference with fireflies".
...
# Fireflies.ai Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `fireflies-embeddings-search`.