---
name: finta-transaction-processing
description: |
  Execute Finta primary workflow: Transaction Processing.
  ...
  Trigger with phrases like "finta process transaction",
  "create and track transactions with finta".
...
## Next Steps
For secondary workflow, see `finta-reporting-compliance`.