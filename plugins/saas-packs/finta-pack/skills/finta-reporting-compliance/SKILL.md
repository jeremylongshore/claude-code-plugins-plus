---
name: finta-reporting-compliance
description: |
  Execute Finta secondary workflow: Reporting & Compliance.
  Use when generating monthly expense reports for accounting,
  or producing audit trails for compliance reviews.
  Trigger with phrases like "finta financial report",
  "generate compliance report with finta".
...
- Familiarity with `finta-transaction-processing`
