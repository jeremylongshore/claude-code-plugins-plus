---
name: maintainx-entity-management
description: |
  Execute MaintainX primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "maintainx manage entities",
  "create or update domain entities with maintainx".
...
# MaintainX Domain Entity Management
...
- Understanding of MaintainX core concepts
...
- Expected results from MaintainX API
...
## Next Steps
For secondary workflow, see `maintainx-data-sync`.