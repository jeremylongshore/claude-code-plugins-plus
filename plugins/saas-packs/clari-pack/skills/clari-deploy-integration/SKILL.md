...
description: |
  Deploy Clari integrations to production platforms.
  Use when deploying Clari-powered applications to production,
  configuring platform-specific secrets, or setting up deployment pipelines.
  Trigger with phrases like "deploy clari", "clari production",
  "clari production deploy", "clari CI/CD".
...
Deploy Clari integrations as webhook workers — always-on endpoints that
...
fly secrets set CLARI_WEBHOOK_SECRET="$CLARI_WEBHOOK_SECRET"
fly deploy
```
