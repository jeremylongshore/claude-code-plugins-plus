---
name: clari-contact-sync
description: |
  Execute Clari primary workflow: Contact Sync & Enrichment.
  ...
  Trigger with phrases like "clari sync contacts",
  "import and enrich contacts with clari".
...
- Access to contacts/deals data in your Clari instance
...
## Next Steps
For secondary workflow, see `clari-deal-pipeline`.