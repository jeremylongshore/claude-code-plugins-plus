---
name: documenso-entity-management
description: |
  Execute Documenso primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "documenso manage entities",
  "create or update domain entities with documenso".
...
# Documenso Domain Entity Management
...
- Understanding of Documenso core concepts
...
- Expected results from Documenso API
...
## Next Steps
For secondary workflow, see `documenso-data-sync`.