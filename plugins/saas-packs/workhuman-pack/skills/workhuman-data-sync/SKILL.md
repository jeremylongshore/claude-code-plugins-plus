---
name: workhuman-data-sync
description: |
  Execute Workhuman secondary workflow: Integration & Data Sync.
  Use when syncing records between systems on a schedule,
  or building real-time event-driven integrations.
  Trigger with phrases like "workhuman sync data",
  "sync between systems with workhuman".
...
# Workhuman Integration & Data Sync
...
- Familiarity with `workhuman-entity-management`
