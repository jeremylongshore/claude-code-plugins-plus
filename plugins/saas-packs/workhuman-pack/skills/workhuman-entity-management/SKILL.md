---
name: workhuman-entity-management
description: |
  Execute Workhuman primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "workhuman manage entities",
  "create or update domain entities with workhuman".
...
# Workhuman Domain Entity Management
...
## Next Steps
For secondary workflow, see `workhuman-data-sync`.