---
name: evernote-search-retrieve
description: |
  Execute Evernote secondary workflow: Search & Knowledge Retrieval.
  Use when finding relevant pages by keyword or tag,
  or building a knowledge base search for internal tools.
  Trigger with phrases like "evernote search",
  "search content with evernote".
...
# Evernote Search & Knowledge Retrieval
...
- Familiarity with `evernote-content-management`
...
## Next Steps
For common errors, see `evernote-common-errors`.