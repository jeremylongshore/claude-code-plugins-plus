---
name: evernote-content-management
description: |
  Execute Evernote primary workflow: Page & Content Management.
  ...
  Trigger with phrases like "evernote manage pages",
  "create or update pages with evernote".
...
# Evernote Page & Content Management
...
- Understanding of Evernote core concepts
...
- Expected results from Evernote API
...
## Next Steps
For secondary workflow, see `evernote-search-retrieve`.