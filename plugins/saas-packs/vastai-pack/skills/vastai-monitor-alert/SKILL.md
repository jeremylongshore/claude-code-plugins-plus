---
name: vastai-monitor-alert
description: |
  Execute Vast.ai primary workflow: Monitor & Alert.
  ...
  Trigger with phrases like "vastai monitor",
  "configure monitoring with vastai".
...
## Next Steps
For secondary workflow, see `vastai-resource-management`.