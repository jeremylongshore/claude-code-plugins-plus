...
description: |
  Deploy Vast.ai integrations to production platforms.
  Use when deploying Vast.ai-powered applications to production,
  configuring platform-specific secrets, or setting up deployment pipelines.
  Trigger with phrases like "deploy vastai", "vastai production",
  "vastai production deploy", "vastai CI/CD".
...
Deploy Vast.ai as a sidecar agent alongside your application, plus webhook
