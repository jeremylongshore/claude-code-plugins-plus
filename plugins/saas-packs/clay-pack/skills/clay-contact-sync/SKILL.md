---
name: clay-contact-sync
description: |
  Execute Clay primary workflow: Contact Sync & Enrichment.
  ...
  Trigger with phrases like "clay sync contacts",
  "import and enrich contacts with clay".
...
- Access to contacts/deals data in your Clay instance
...
## Next Steps
For secondary workflow, see `clay-deal-pipeline`.