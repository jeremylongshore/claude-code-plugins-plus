...
description: |
  Deploy Clay integrations to production platforms.
  Use when deploying Clay-powered applications to production,
  configuring platform-specific secrets, or setting up deployment pipelines.
  Trigger with phrases like "deploy clay", "clay production",
  "clay production deploy", "clay CI/CD".
...
Deploy Clay integrations as webhook workers — always-on endpoints that
...
fly secrets set CLAY_WEBHOOK_SECRET="$CLAY_WEBHOOK_SECRET"
fly deploy
```
