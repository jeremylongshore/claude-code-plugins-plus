---
name: cohere-model-inference
description: |
  Execute Cohere primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "cohere inference",
  "run model inference with cohere".
...
# Cohere Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `cohere-embeddings-search`.