---
name: langfuse-embeddings-search
description: |
  Execute Langfuse secondary workflow: Embeddings & Semantic Search.
  Use when building a RAG pipeline over documents,
  or semantic similarity search across content.
  Trigger with phrases like "langfuse embeddings",
  "generate embeddings with langfuse".
...
# Langfuse Embeddings & Semantic Search
...
- Familiarity with `langfuse-model-inference`
...
## Next Steps
For common errors, see `langfuse-common-errors`.