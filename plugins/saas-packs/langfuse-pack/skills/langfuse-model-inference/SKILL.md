---
name: langfuse-model-inference
description: |
  Execute Langfuse primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "langfuse inference",
  "run model inference with langfuse".
...
# Langfuse Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `langfuse-embeddings-search`.