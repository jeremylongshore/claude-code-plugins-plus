---
name: castai-resource-management
description: |
  Execute Cast AI secondary workflow: Resource Management.
  Use when provisioning GPU instances for ML workloads,
  or auto-scaling infrastructure based on demand.
  Trigger with phrases like "castai manage resources",
  "provision infrastructure with castai".
...
- Familiarity with `castai-monitor-alert`
