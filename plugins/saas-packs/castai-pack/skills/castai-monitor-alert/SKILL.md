---
name: castai-monitor-alert
description: |
  Execute Cast AI primary workflow: Monitor & Alert.
  ...
  Trigger with phrases like "castai monitor",
  "configure monitoring with castai".
...
## Next Steps
For secondary workflow, see `castai-resource-management`.