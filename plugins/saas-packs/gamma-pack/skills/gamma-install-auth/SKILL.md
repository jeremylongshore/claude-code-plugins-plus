...
- OAuth2 access token or personal API token from Gamma settings
...
export GAMMA_ACCESS_TOKEN="your-access-token"

# Or create .env file
echo 'GAMMA_ACCESS_TOKEN=your-access-token' >> .env
```
...
client = GammaClient(
    ...
    access_token=os.environ.get('GAMMA_ACCESS_TOKEN')
