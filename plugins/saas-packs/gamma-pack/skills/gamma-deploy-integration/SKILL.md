...
description: |
  Deploy Gamma integrations to production platforms.
  Use when deploying Gamma-powered applications to production,
  configuring platform-specific secrets, or setting up deployment pipelines.
  Trigger with phrases like "deploy gamma", "gamma production",
  "gamma production deploy", "gamma CI/CD".
...
Deploy Gamma integration as a CI/CD pipeline step that exports assets,
