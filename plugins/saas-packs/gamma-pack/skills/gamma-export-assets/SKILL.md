---
name: gamma-export-assets
description: |
  Execute Gamma primary workflow: Export & Asset Pipeline.
  ...
  Trigger with phrases like "gamma export assets",
  "export design assets with gamma".
...
## Next Steps
For secondary workflow, see `gamma-design-token-sync`.