---
name: veeva-data-sync
description: |
  Execute Veeva secondary workflow: Integration & Data Sync.
  Use when syncing records between systems on a schedule,
  or building real-time event-driven integrations.
  Trigger with phrases like "veeva sync data",
  "sync between systems with veeva".
...
- Familiarity with `veeva-entity-management`
