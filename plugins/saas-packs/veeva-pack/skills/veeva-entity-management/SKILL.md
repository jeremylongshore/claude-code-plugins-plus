---
name: veeva-entity-management
description: |
  Execute Veeva primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "veeva manage entities",
  "create or update domain entities with veeva".
...
# Veeva Domain Entity Management
...
## Next Steps
For secondary workflow, see `veeva-data-sync`.