---
name: perplexity-model-inference
description: |
  Execute Perplexity primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "perplexity inference",
  "run model inference with perplexity".
...
# Perplexity Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `perplexity-embeddings-search`.