...
- API key from Perplexity dashboard (starts with `sk-` or similar prefix)
...
| Invalid API Key | Key is missing, expired, or has extra whitespace | Verify key in Perplexity dashboard. Check for trailing newlines |
| Rate Limited | Exceeded requests/tokens per minute | Check usage at https://docs.perplexity.com/usage |
