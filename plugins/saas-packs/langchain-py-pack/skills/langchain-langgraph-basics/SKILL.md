...
description: |
  Analyze, implement, and verify StateGraph, typed TypedDict state, nodes, edges, compile, recursion limits against LangChain 1.0.x baseline.
  Use when you need to stategraph.
  Trigger with "langchain langgraph basics", "langgraph langgraph basics", "langgraph basics".
...
This skill covers: stategraph, typed typeddict state, nodes, edges, compile, recursion limits. The full v2.0 treatment will open with P18 from the pain catalog — a real production failure mode — and walk through the exact fix with code pinned to LangChain 1.0.x.

Baseline: `langchain-core 1.0.x`, `langgraph 1.0.x`. Pain-catalog anchors: `P18`, `P20`, `P55`, `P56`
