...
description: |
  Analyze, implement, and verify Streaming, batch concurrency, semantic caching, RedisChatMessageHistory against LangChain 1.0.x baseline.
  Use when you need to streaming.
  Trigger with "langchain performance tuning", "langchain python performance tuning", "performance tuning".
...
This skill covers: streaming, batch concurrency, semantic caching, redischatmessagehistory. The full v2.0 treatment will open with P01 from the pain catalog — a real production failure mode — and walk through the exact fix with code pinned to LangChain 1.0.x.

Baseline: `langchain-core 1.0.x`, `langgraph 1.0.x`. Pain-catalog anchors: `P01`, `P08`, `P22`, `P48`, `P59`, `P60`, `P62`
