...
description: |
  Analyze, implement, and verify astream_events v2, trace callbacks, LangSmith export, diagnostic dumps against LangChain 1.0.x baseline.
  Use when you need to astream_events v2.
  Trigger with "langchain debug bundle", "langchain python debug bundle", "debug bundle".
...
This skill covers: astream_events v2, trace callbacks, langsmith export, diagnostic dumps. The full v2.0 treatment will open with P01 from the pain catalog — a real production failure mode — and walk through the exact fix with code pinned to LangChain 1.0.x.

Baseline: `langchain-core 1.0.x`, `langgraph 1.0.x`. Pain-catalog anchors: `P01`, `P06`, `P28`, `P47`, `P67`
