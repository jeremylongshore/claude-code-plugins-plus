...
description: |
  Analyze, implement, and verify Minimal LangChain chain with ChatAnthropic, structured output, and streaming against LangChain 1.0.x baseline.
  Use when you need to minimal langchain chain with chatanthropic.
  Trigger with "langchain hello world", "langchain python hello world", "hello world".
...
This skill covers: minimal langchain chain with chatanthropic, structured output, and streaming. The full v2.0 treatment will open with P02 from the pain catalog — a real production failure mode — and walk through the exact fix with code pinned to LangChain 1.0.x.

Baseline: `langchain-core 1.0.x`, `langgraph 1.0.x`. Pain-catalog anchors: `P02`, `P03`
