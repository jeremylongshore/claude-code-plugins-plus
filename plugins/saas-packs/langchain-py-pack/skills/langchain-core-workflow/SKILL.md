...
description: |
  Analyze, implement, and verify RunnableParallel, RunnableBranch, RunnablePassthrough.assign, RAG composition against LangChain 1.0.x baseline.
  Use when you need to runnableparallel.
  Trigger with "langchain core workflow", "langchain python core workflow", "core workflow".
...
This skill covers: runnableparallel, runnablebranch, runnablepassthrough.assign, rag composition. The full v2.0 treatment will open with P06 from the pain catalog — a real production failure mode — and walk through the exact fix with code pinned to LangChain 1.0.x.

Baseline: `langchain-core 1.0.x`, `langgraph 1.0.x`. Pain-catalog anchors: `P06`, `P09`
