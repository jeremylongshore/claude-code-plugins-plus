...
description: |
  Analyze, implement, and verify 0.2 to 0.3 to 1.0 migration with named breaking changes and codemod hints against LangChain 1.0.x baseline.
  Use when you need to 0.2 to 0.3 to 1.0 migration with named breaking changes and codemod hints.
  Trigger with "langchain upgrade migration", "langchain python upgrade migration", "upgrade migration".
...
This skill covers: 0.2 to 0.3 to 1.0 migration with named breaking changes and codemod hints. The full v2.0 treatment will open with P14 from the pain catalog — a real production failure mode — and walk through the exact fix with code pinned to LangChain 1.0.x.

Baseline: `langchain-core 1.0.x`, `langgraph 1.0.x`. Pain-catalog anchors: `P14`, `P20`, `P38`, `P39`, `P40`, `P41`, `P42`, `P66`, `P67`
