...
description: |
  Analyze, implement, and verify LangServe, Cloud Run, Vercel Python runtime, secret management against LangChain 1.0.x baseline.
  Use when you need to langserve.
  Trigger with "langchain deploy integration", "langchain python deploy integration", "deploy integration".
allowed-tools: Read, Write, Edit, Bash(gcloud:*), Bash(vercel:*)
version: 2.0.0
license: MIT
...
This skill covers: langserve, cloud run, vercel python runtime, secret management. The full v2.0 treatment will open with P35 from the pain catalog — a real production failure mode — and walk through the exact fix with code pinned to LangChain 1.0.x.

Baseline: `langchain-core 1.0.x`, `langgraph 1.0.x`. Pain-catalog anchors: `P35`, `P36`, `P37`, `P46`
