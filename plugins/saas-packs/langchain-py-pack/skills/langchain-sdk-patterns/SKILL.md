...
description: |
  Analyze, implement, and verify RunnableSequence, with_fallbacks, batch, abatch, retries, concurrency caps against LangChain 1.0.x baseline.
  Use when you need to runnablesequence.
  Trigger with "langchain sdk patterns", "langchain python sdk patterns", "sdk patterns".
...
This skill covers: runnablesequence, with_fallbacks, batch, abatch, retries, concurrency caps. The full v2.0 treatment will open with P07 from the pain catalog — a real production failure mode — and walk through the exact fix with code pinned to LangChain 1.0.x.

Baseline: `langchain-core 1.0.x`, `langgraph 1.0.x`. Pain-catalog anchors: `P07`, `P08`, `P53`, `P57`
