...
description: |
  Analyze, implement, and verify 30-item go-live checklist with concrete thresholds, timeouts, budget caps against LangChain 1.0.x baseline.
  Use when you need to 30-item go-live checklist with concrete thresholds.
  Trigger with "langchain prod checklist", "langchain python prod checklist", "prod checklist".
allowed-tools: Read
version: 2.0.0
license: MIT
...
This skill covers: 30-item go-live checklist with concrete thresholds, timeouts, budget caps. The full v2.0 treatment will open with P10 from the pain catalog — a real production failure mode — and walk through the exact fix with code pinned to LangChain 1.0.x.

Baseline: `langchain-core 1.0.x`, `langgraph 1.0.x`. Pain-catalog anchors: `P10`, `P20`, `P29`, `P35`, `P36`, `P37`
