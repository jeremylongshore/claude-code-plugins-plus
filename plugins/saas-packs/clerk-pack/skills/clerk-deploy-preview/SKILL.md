---
name: clerk-deploy-preview
description: |
  Execute Clerk primary workflow: Deploy & Preview.
  Use when deploying a preview for every pull request,
  promoting staging to production, or rolling back a bad deployment.
  Trigger with phrases like "clerk deploy",
  "deploy application with clerk".
...
## Next Steps
For secondary workflow, see `clerk-build-configure`.