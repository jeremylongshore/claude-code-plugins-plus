---
name: clerk-build-configure
description: |
  Execute Clerk secondary workflow: Build & Configure.
  Use when setting environment variables for different stages,
  or configuring build commands and output directories.
  Trigger with phrases like "clerk configure",
  "configure project with clerk".
...
- Familiarity with `clerk-deploy-preview`
...
## Next Steps
For common errors, see `clerk-common-errors`.