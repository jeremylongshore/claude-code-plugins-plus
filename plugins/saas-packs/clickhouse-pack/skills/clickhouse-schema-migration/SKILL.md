...
description: |
  Execute ClickHouse secondary workflow: Schema Migration & Data Modeling.
  Use when creating tables and indexes for a new feature,
  or altering columns without downtime.
  Trigger with phrases like "clickhouse migration",
  "run schema migration with clickhouse".
...
# ClickHouse Schema Migration & Data Modeling
...
- Familiarity with `clickhouse-query-transform`
