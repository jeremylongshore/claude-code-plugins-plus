---
name: clickhouse-query-transform
description: |
  Execute ClickHouse primary workflow: Query & Transform Data.
  ...
  Trigger with phrases like "clickhouse query data",
  "run analytical query with clickhouse".
...
# ClickHouse Query & Transform Data
...
## Next Steps
For secondary workflow, see `clickhouse-schema-migration`.