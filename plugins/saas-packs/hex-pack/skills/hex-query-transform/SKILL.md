---
name: hex-query-transform
description: |
  Execute Hex primary workflow: Query & Transform Data.
  ...
  Trigger with phrases like "hex query data",
  "run analytical query with hex".
...
## Next Steps
For secondary workflow, see `hex-schema-migration`.