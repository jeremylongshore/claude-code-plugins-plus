---
name: hex-schema-migration
description: |
  Execute Hex secondary workflow: Schema Migration & Data Modeling.
  Use when creating tables and indexes for a new feature,
  or altering columns without downtime.
  Trigger with phrases like "hex migration",
  "run schema migration with hex".
...
# Hex Schema Migration & Data Modeling
...
- Familiarity with `hex-query-transform`
