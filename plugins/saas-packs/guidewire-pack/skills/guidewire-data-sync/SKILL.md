---
name: guidewire-data-sync
description: |
  Execute Guidewire secondary workflow: Integration & Data Sync.
  Use when syncing records between systems on a schedule,
  or building real-time event-driven integrations.
  Trigger with phrases like "guidewire sync data",
  "sync between systems with guidewire".
...
# Guidewire Integration & Data Sync
...
- Familiarity with `guidewire-entity-management`
