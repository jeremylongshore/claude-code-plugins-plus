...
- API key from Kling AI dashboard
...
|-------|-------|----------|
| Invalid API Key | Incorrect or expired key | Verify key in Kling AI dashboard |
| Rate Limited | Exceeded quota | Check quota at https://docs.klingai.com |
