---
name: klingai-model-inference
description: |
  Execute Kling AI primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "klingai inference",
  "run model inference with klingai".
...
# Kling AI Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `klingai-embeddings-search`.