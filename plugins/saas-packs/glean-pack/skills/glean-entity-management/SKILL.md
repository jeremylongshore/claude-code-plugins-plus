---
name: glean-entity-management
description: |
  Execute Glean primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "glean manage entities",
  "create or update domain entities with glean".
...
# Glean Domain Entity Management
...
## Next Steps
For secondary workflow, see `glean-data-sync`.