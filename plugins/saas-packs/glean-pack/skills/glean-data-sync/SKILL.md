---
name: glean-data-sync
description: |
  Execute Glean secondary workflow: Integration & Data Sync.
  Use when syncing records between systems on a schedule,
  or building real-time event-driven integrations.
  Trigger with phrases like "glean sync data",
  "sync between systems with glean".
...
- Familiarity with `glean-entity-management`
