---
name: granola-content-management
description: |
  Execute Granola primary workflow: Page & Content Management.
  ...
  Trigger with phrases like "granola manage pages",
  "create or update pages with granola".
...
# Granola Page & Content Management
...
- Understanding of Granola core concepts
...
- Expected results from Granola API
...
## Next Steps
For secondary workflow, see `granola-search-retrieve`.