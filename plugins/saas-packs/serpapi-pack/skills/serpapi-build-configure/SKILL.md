---
name: serpapi-build-configure
description: |
  Execute SerpApi secondary workflow: Build & Configure.
  Use when setting environment variables for different stages,
  or configuring build commands and output directories.
  Trigger with phrases like "serpapi configure",
  "configure project with serpapi".
...
- Familiarity with `serpapi-deploy-preview`
