---
name: serpapi-deploy-preview
description: |
  Execute SerpApi primary workflow: Deploy & Preview.
  Use when deploying a preview for every pull request,
  promoting staging to production, or rolling back a bad deployment.
  Trigger with phrases like "serpapi deploy",
  "deploy application with serpapi".
...
## Next Steps
For secondary workflow, see `serpapi-build-configure`.