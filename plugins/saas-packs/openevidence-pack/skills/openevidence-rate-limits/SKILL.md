...
description: |
  Implement OpenEvidence rate limiting, backoff, and idempotency patterns.
  Use when handling rate limit errors, implementing retry logic,
  or optimizing API request throughput for OpenEvidence.
...
## Overview
Handle OpenEvidence rate limits gracefully with exponential backoff and idempotency.
...
## Resources
- [OpenEvidence Rate Limits](https://docs.openevidence.com/rate-limits)
