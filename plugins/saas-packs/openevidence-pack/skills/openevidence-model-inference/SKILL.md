---
name: openevidence-model-inference
description: |
  Execute OpenEvidence primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "openevidence inference",
  "run model inference with openevidence".
...
# OpenEvidence Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `openevidence-embeddings-search`.