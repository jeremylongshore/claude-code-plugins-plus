---
name: wispr-model-inference
description: |
  Execute Wispr primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "wispr inference",
  "run model inference with wispr".
...
# Wispr Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `wispr-embeddings-search`.