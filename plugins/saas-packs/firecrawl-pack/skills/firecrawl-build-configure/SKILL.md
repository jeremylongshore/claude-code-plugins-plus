---
name: firecrawl-build-configure
description: |
  Execute FireCrawl secondary workflow: Build & Configure.
  Use when setting environment variables for different stages,
  or configuring build commands and output directories.
  Trigger with phrases like "firecrawl configure",
  "configure project with firecrawl".
...
- Familiarity with `firecrawl-deploy-preview`
