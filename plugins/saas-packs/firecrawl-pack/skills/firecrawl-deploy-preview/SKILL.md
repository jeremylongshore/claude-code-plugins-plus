---
name: firecrawl-deploy-preview
description: |
  Execute FireCrawl primary workflow: Deploy & Preview.
  Use when deploying a preview for every pull request,
  promoting staging to production, or rolling back a bad deployment.
  Trigger with phrases like "firecrawl deploy",
  "deploy application with firecrawl".
...
## Next Steps
For secondary workflow, see `firecrawl-build-configure`.