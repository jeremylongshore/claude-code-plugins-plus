---
name: shopify-entity-management
description: |
  Execute Shopify primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "shopify manage entities",
  "create or update domain entities with shopify".
...
# Shopify Domain Entity Management
...
## Next Steps
For secondary workflow, see `shopify-data-sync`.