---
name: groq-model-inference
description: |
  Execute Groq primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "groq inference",
  "run model inference with groq".
...
## Next Steps
For secondary workflow, see `groq-embeddings-search`.