---
name: coderabbit-build-configure
description: |
  Execute CodeRabbit secondary workflow: Build & Configure.
  Use when setting environment variables for different stages,
  or configuring build commands and output directories.
  Trigger with phrases like "coderabbit configure",
  "configure project with coderabbit".
...
- Familiarity with `coderabbit-deploy-preview`
