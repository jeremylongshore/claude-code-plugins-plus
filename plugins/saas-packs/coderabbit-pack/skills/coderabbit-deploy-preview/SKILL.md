---
name: coderabbit-deploy-preview
description: |
  Execute CodeRabbit primary workflow: Deploy & Preview.
  Use when deploying a preview for every pull request,
  promoting staging to production, or rolling back a bad deployment.
  Trigger with phrases like "coderabbit deploy",
  "deploy application with coderabbit".
...
## Next Steps
For secondary workflow, see `coderabbit-build-configure`.