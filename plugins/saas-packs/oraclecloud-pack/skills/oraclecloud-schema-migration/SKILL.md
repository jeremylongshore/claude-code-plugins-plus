...
description: |
  Execute Oracle Cloud secondary workflow: Schema Migration & Data Modeling.
  Use when creating tables and indexes for a new feature,
  or altering columns without downtime.
  Trigger with phrases like "oraclecloud migration",
  "run schema migration with oraclecloud".
...
# Oracle Cloud Schema Migration & Data Modeling
...
- Familiarity with `oraclecloud-query-transform`
