...
description: |
  Execute Oracle Cloud primary workflow: Query & Transform Data.
  ...
  Trigger with phrases like "oraclecloud query data",
  "run analytical query with oraclecloud".
...
# Oracle Cloud Query & Transform Data
...
## Next Steps
For secondary workflow, see `oraclecloud-schema-migration`.