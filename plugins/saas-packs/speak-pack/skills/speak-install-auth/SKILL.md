...
|-------|-------|----------|
| Invalid API Key | Incorrect or expired key | Verify key in Speak dashboard |
| Rate Limited | Exceeded quota | Check quota at https://docs.speak.com |
