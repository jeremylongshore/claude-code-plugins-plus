---
name: speak-model-inference
description: |
  Execute Speak primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "speak inference",
  "run model inference with speak".
...
# Speak Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `speak-embeddings-search`.