...
description: |
  ...
  Use when encountering Speak errors, debugging failed requests,
  or troubleshooting integration issues.
  Trigger with phrases like "speak error", "fix speak",
  "speak not working", "debug speak".
...
Quick reference for the most common Speak API errors: authentication failures, rate limits, context length issues, and model availability.
...
```bash
# Check Speak status
curl -s https://status.speak.com

# Verify API connectivity
curl -I https://api.speak.com
