---
name: mindtickle-contact-sync
description: |
  Execute Mindtickle primary workflow: Contact Sync & Enrichment.
  ...
  Trigger with phrases like "mindtickle sync contacts",
  "import and enrich contacts with mindtickle".
...
# Mindtickle Contact Sync & Enrichment
...
- Access to contacts/deals data in your Mindtickle instance
...
## Next Steps
For secondary workflow, see `mindtickle-deal-pipeline`.