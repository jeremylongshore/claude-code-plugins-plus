---
name: palantir-query-transform
description: |
  Execute Palantir primary workflow: Query & Transform Data.
  ...
  Trigger with phrases like "palantir query data",
  "run analytical query with palantir".
...
## Next Steps
For secondary workflow, see `palantir-schema-migration`.