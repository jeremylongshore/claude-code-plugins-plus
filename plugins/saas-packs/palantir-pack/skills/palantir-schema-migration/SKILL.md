---
name: palantir-schema-migration
description: |
  Execute Palantir secondary workflow: Schema Migration & Data Modeling.
  Use when creating tables and indexes for a new feature,
  or altering columns without downtime.
  Trigger with phrases like "palantir migration",
  "run schema migration with palantir".
...
# Palantir Schema Migration & Data Modeling
...
- Familiarity with `palantir-query-transform`
