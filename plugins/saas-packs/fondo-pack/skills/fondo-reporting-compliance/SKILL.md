---
name: fondo-reporting-compliance
description: |
  Execute Fondo secondary workflow: Reporting & Compliance.
  Use when generating monthly expense reports for accounting,
  or producing audit trails for compliance reviews.
  Trigger with phrases like "fondo financial report",
  "generate compliance report with fondo".
...
- Familiarity with `fondo-transaction-processing`
