---
name: windsurf-build-configure
description: |
  Execute Windsurf secondary workflow: Build & Configure.
  Use when setting environment variables for different stages,
  or configuring build commands and output directories.
  Trigger with phrases like "windsurf configure",
  "configure project with windsurf".
...
- Familiarity with `windsurf-deploy-preview`
