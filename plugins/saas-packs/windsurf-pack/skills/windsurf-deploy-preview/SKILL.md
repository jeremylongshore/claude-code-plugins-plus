---
name: windsurf-deploy-preview
description: |
  Execute Windsurf primary workflow: Deploy & Preview.
  Use when deploying a preview for every pull request,
  promoting staging to production, or rolling back a bad deployment.
  Trigger with phrases like "windsurf deploy",
  "deploy application with windsurf".
...
## Next Steps
For secondary workflow, see `windsurf-build-configure`.