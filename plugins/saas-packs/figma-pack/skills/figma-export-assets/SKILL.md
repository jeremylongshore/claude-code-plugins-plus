...
description: |
  Execute Figma primary workflow: Export & Asset Pipeline.
  ...
  Trigger with phrases like "figma export assets",
  "export design assets with figma".
...
## Next Steps
For secondary workflow, see `figma-design-token-sync`.