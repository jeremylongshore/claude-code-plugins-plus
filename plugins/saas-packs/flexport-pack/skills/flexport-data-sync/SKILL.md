---
name: flexport-data-sync
description: |
  Execute Flexport secondary workflow: Integration & Data Sync.
  Use when syncing records between systems on a schedule,
  or building real-time event-driven integrations.
  Trigger with phrases like "flexport sync data",
  "sync between systems with flexport".
...
# Flexport Integration & Data Sync
...
- Familiarity with `flexport-entity-management`
