---
name: flexport-entity-management
description: |
  Execute Flexport primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "flexport manage entities",
  "create or update domain entities with flexport".
...
# Flexport Domain Entity Management
...
## Next Steps
For secondary workflow, see `flexport-data-sync`.