---
name: hootsuite-event-tracking
description: |
  Execute Hootsuite secondary workflow: Event Tracking & Segmentation.
  Use when tracking product usage events to trigger messages,
  or building behavioral segments for campaign targeting.
  Trigger with phrases like "hootsuite track events",
  "track user events with hootsuite".
...
# Hootsuite Event Tracking & Segmentation
...
- Familiarity with `hootsuite-campaign-delivery`
