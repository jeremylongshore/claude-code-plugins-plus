---
name: apify-build-configure
description: |
  Execute Apify secondary workflow: Build & Configure.
  Use when setting environment variables for different stages,
  or configuring build commands and output directories.
  Trigger with phrases like "apify configure",
  "configure project with apify".
...
- Familiarity with `apify-deploy-preview`
