---
name: mistral-embeddings-search
description: |
  Execute Mistral AI secondary workflow: Embeddings & Semantic Search.
  Use when building a RAG pipeline over documents,
  or semantic similarity search across content.
  Trigger with phrases like "mistral embeddings",
...
# Mistral AI Embeddings & Semantic Search
...
- Familiarity with `mistral-model-inference`
