...
description: |
  ...
  Use when upgrading Mistral AI SDK versions, detecting deprecations,
...
```bash
npm list @mistral/sdk
npm view @mistral/sdk version
```

### Step 2: Review Changelog
```bash
open https://github.com/mistral/sdk/releases
```

### Step 3: Create Upgrade Branch
```bash
git checkout -b upgrade/mistral-sdk-vX.Y.Z
npm install @mistral/sdk@latest
npm test
```
...
### Rollback Procedure
```bash
npm install @mistral/sdk@1.x.x --save-exact
```
...
if (process.env.NODE_ENV === 'development') {
  process.on('warning', (warning) => {
    if (warning.name === 'DeprecationWarning') {
      console.warn('[Mistral AI]', warning.message);
...
## Resources
- [Mistral AI Changelog](https://github.com/mistral/sdk/releases)
- [Mistral AI Migration Guide](https://docs.mistral.com/migration)
