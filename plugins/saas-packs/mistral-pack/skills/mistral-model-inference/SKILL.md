---
name: mistral-model-inference
description: |
  Execute Mistral AI primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "mistral inference",
  "run model inference with mistral".
...
# Mistral AI Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `mistral-embeddings-search`.