---
name: onenote-search-retrieve
description: |
  Execute OneNote secondary workflow: Search & Knowledge Retrieval.
  Use when finding relevant pages by keyword or tag,
  or building a knowledge base search for internal tools.
  Trigger with phrases like "onenote search",
  "search content with onenote".
...
# OneNote Search & Knowledge Retrieval
...
- Familiarity with `onenote-content-management`
