---
name: elevenlabs-model-inference
description: |
  Execute ElevenLabs primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "elevenlabs inference",
  "run model inference with elevenlabs".
...
# ElevenLabs Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `elevenlabs-embeddings-search`.