---
name: elevenlabs-embeddings-search
description: |
  Execute ElevenLabs secondary workflow: Embeddings & Semantic Search.
  Use when building a RAG pipeline over documents,
  or semantic similarity search across content.
  Trigger with phrases like "elevenlabs embeddings",
  "generate embeddings with elevenlabs".
...
# ElevenLabs Embeddings & Semantic Search
...
- Familiarity with `elevenlabs-model-inference`
