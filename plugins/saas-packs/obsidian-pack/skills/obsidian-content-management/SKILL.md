---
name: obsidian-content-management
description: |
  Execute Obsidian primary workflow: Page & Content Management.
  ...
  Trigger with phrases like "obsidian manage pages",
  "create or update pages with obsidian".
...
# Obsidian Page & Content Management
...
- Understanding of Obsidian core concepts
...
- Expected results from Obsidian API
...
## Next Steps
For secondary workflow, see `obsidian-search-retrieve`.