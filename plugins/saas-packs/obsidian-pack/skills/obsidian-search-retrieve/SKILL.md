---
name: obsidian-search-retrieve
description: |
  Execute Obsidian secondary workflow: Search & Knowledge Retrieval.
  Use when finding relevant pages by keyword or tag,
  or building a knowledge base search for internal tools.
  Trigger with phrases like "obsidian search",
  "search content with obsidian".
...
# Obsidian Search & Knowledge Retrieval
...
- Familiarity with `obsidian-content-management`
