---
name: deepgram-model-inference
description: |
  Execute Deepgram primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "deepgram inference",
  "run model inference with deepgram".
...
# Deepgram Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `deepgram-embeddings-search`.