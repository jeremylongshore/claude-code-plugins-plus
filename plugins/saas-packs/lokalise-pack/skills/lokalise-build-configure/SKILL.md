---
name: lokalise-build-configure
description: |
  Execute Lokalise secondary workflow: Build & Configure.
  Use when setting environment variables for different stages,
  or configuring build commands and output directories.
  Trigger with phrases like "lokalise configure",
  "configure project with lokalise".
...
- Familiarity with `lokalise-deploy-preview`
