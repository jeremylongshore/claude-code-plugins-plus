---
name: lokalise-deploy-preview
description: |
  Execute Lokalise primary workflow: Deploy & Preview.
  Use when deploying a preview for every pull request,
  promoting staging to production, or rolling back a bad deployment.
  Trigger with phrases like "lokalise deploy",
  "deploy application with lokalise".
...
## Next Steps
For secondary workflow, see `lokalise-build-configure`.