...
description: |
  Implement Lokalise rate limiting, backoff, and idempotency patterns.
...
## Overview
Handle Lokalise rate limits gracefully with exponential backoff and idempotency.
...
## Resources
- [Lokalise Rate Limits](https://docs.lokalise.com/rate-limits)
