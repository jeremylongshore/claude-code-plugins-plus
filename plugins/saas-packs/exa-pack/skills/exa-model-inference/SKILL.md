---
name: exa-model-inference
description: |
  Execute Exa primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "exa inference",
  "run model inference with exa".
...
## Next Steps
For secondary workflow, see `exa-embeddings-search`.