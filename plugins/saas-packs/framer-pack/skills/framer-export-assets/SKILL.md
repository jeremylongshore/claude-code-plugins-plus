---
name: framer-export-assets
description: |
  Execute Framer primary workflow: Export & Asset Pipeline.
  ...
  Trigger with phrases like "framer export assets",
  "export design assets with framer".
...
## Next Steps
For secondary workflow, see `framer-design-token-sync`.