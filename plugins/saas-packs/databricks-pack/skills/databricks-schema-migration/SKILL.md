---
name: databricks-schema-migration
description: |
  Execute Databricks secondary workflow: Schema Migration & Data Modeling.
  Use when creating tables and indexes for a new feature,
  or altering columns without downtime.
  Trigger with phrases like "databricks migration",
  "run schema migration with databricks".
...
# Databricks Schema Migration & Data Modeling
...
- Familiarity with `databricks-query-transform`
