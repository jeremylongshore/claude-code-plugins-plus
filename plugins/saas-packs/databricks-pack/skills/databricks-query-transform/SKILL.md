---
name: databricks-query-transform
description: |
  Execute Databricks primary workflow: Query & Transform Data.
  ...
  Trigger with phrases like "databricks query data",
  "run analytical query with databricks".
...
# Databricks Query & Transform Data
...
## Next Steps
For secondary workflow, see `databricks-schema-migration`.