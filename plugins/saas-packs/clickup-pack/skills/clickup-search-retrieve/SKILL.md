---
name: clickup-search-retrieve
description: |
  Execute ClickUp secondary workflow: Search & Knowledge Retrieval.
  Use when finding relevant pages by keyword or tag,
  or building a knowledge base search for internal tools.
  Trigger with phrases like "clickup search",
  "search content with clickup".
...
# ClickUp Search & Knowledge Retrieval
...
- Familiarity with `clickup-content-management`
