---
name: replit-build-configure
description: |
  Execute Replit secondary workflow: Build & Configure.
  Use when setting environment variables for different stages,
  or configuring build commands and output directories.
  Trigger with phrases like "replit configure",
  "configure project with replit".
...
- Familiarity with `replit-deploy-preview`
