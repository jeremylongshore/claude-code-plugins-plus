---
name: attio-contact-sync
description: |
  Execute Attio primary workflow: Contact Sync & Enrichment.
  ...
  Trigger with phrases like "attio sync contacts",
  "import and enrich contacts with attio".
...
- Access to contacts/deals data in your Attio instance
...
## Next Steps
For secondary workflow, see `attio-deal-pipeline`.