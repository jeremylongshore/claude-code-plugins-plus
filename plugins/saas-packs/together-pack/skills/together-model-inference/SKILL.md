---
name: together-model-inference
description: |
  Execute Together AI primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "together inference",
  "run model inference with together".
...
# Together AI Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `together-embeddings-search`.