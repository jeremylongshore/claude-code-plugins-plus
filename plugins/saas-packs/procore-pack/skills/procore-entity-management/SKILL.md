---
name: procore-entity-management
description: |
  Execute Procore primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "procore manage entities",
  "create or update domain entities with procore".
...
# Procore Domain Entity Management
...
## Next Steps
For secondary workflow, see `procore-data-sync`.