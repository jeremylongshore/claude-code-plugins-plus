---
name: linear-search-retrieve
description: |
  Execute Linear secondary workflow: Search & Knowledge Retrieval.
  Use when finding relevant pages by keyword or tag,
  or building a knowledge base search for internal tools.
  Trigger with phrases like "linear search",
  "search content with linear".
...
# Linear Search & Knowledge Retrieval
...
- Familiarity with `linear-content-management`
...
## Next Steps
For common errors, see `linear-common-errors`.