---
name: lindy-model-inference
description: |
  Execute Lindy primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "lindy inference",
  "run model inference with lindy".
...
# Lindy Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `lindy-embeddings-search`.