...
- API key from Lindy dashboard (starts with `sk-` or similar prefix)
...
| Invalid API Key | Key is missing, expired, or has extra whitespace | Verify key in Lindy dashboard. Check for trailing newlines |
| Rate Limited | Exceeded requests/tokens per minute | Check usage at https://docs.lindy.com/usage |
