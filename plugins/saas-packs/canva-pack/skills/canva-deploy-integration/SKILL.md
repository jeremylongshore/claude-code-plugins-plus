...
description: |
  Deploy Canva integrations to production platforms.
  Use when deploying Canva-powered applications to production,
  configuring platform-specific secrets, or setting up deployment pipelines.
  Trigger with phrases like "deploy canva", "canva production",
  "canva production deploy", "canva CI/CD".
...
Deploy Canva integration as a CI/CD pipeline step that exports assets,
