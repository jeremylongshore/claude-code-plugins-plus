---
name: canva-export-assets
description: |
  Execute Canva primary workflow: Export & Asset Pipeline.
  ...
  Trigger with phrases like "canva export assets",
  "export design assets with canva".
...
## Next Steps
For secondary workflow, see `canva-design-token-sync`.