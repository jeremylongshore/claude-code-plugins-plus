---
name: lucidchart-export-assets
description: |
  Execute Lucidchart primary workflow: Export & Asset Pipeline.
  ...
  Trigger with phrases like "lucidchart export assets",
  "export design assets with lucidchart".
...
# Lucidchart Export & Asset Pipeline
...
## Next Steps
For secondary workflow, see `lucidchart-design-token-sync`.