---
name: lucidchart-design-token-sync
description: |
  Execute Lucidchart secondary workflow: Design Token Sync.
  Use when keeping CSS variables in sync with design system,
  or generating Tailwind theme config from design files.
  Trigger with phrases like "lucidchart design tokens",
  "sync design tokens with lucidchart".
...
- Familiarity with `lucidchart-export-assets`
