---
name: coreweave-resource-management
description: |
  Execute CoreWeave secondary workflow: Resource Management.
  Use when provisioning GPU instances for ML workloads,
  or auto-scaling infrastructure based on demand.
  Trigger with phrases like "coreweave manage resources",
  "provision infrastructure with coreweave".
...
- Familiarity with `coreweave-monitor-alert`
