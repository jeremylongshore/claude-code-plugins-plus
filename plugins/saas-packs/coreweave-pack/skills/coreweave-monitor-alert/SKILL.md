---
name: coreweave-monitor-alert
description: |
  Execute CoreWeave primary workflow: Monitor & Alert.
  ...
  Trigger with phrases like "coreweave monitor",
  "configure monitoring with coreweave".
...
## Next Steps
For secondary workflow, see `coreweave-resource-management`.