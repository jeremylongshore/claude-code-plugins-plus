---
name: retellai-model-inference
description: |
  Execute Retell AI primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "retellai inference",
  "run model inference with retellai".
...
# Retell AI Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `retellai-embeddings-search`.