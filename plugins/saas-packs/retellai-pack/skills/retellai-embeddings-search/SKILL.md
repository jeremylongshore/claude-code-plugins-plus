---
name: retellai-embeddings-search
description: |
  Execute Retell AI secondary workflow: Embeddings & Semantic Search.
  Use when building a RAG pipeline over documents,
  or semantic similarity search across content.
  Trigger with phrases like "retellai embeddings",
  "generate embeddings with retellai".
...
# Retell AI Embeddings & Semantic Search
...
- Familiarity with `retellai-model-inference`
