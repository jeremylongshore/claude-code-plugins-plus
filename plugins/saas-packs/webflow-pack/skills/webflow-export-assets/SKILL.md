---
name: webflow-export-assets
description: |
  Execute Webflow primary workflow: Export & Asset Pipeline.
  ...
  Trigger with phrases like "webflow export assets",
  "export design assets with webflow".
...
## Next Steps
For secondary workflow, see `webflow-design-token-sync`.