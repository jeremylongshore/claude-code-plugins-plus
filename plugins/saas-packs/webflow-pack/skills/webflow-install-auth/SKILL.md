...
- OAuth2 access token or personal API token from Webflow settings
...
export WEBFLOW_ACCESS_TOKEN="your-access-token"

# Or create .env file
echo 'WEBFLOW_ACCESS_TOKEN=your-access-token' >> .env
```
