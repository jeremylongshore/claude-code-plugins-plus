---
name: flyio-build-configure
description: |
  Execute Fly.io secondary workflow: Build & Configure.
  Use when setting environment variables for different stages,
  or configuring build commands and output directories.
  Trigger with phrases like "flyio configure",
  "configure project with flyio".
...
- Familiarity with `flyio-deploy-preview`
