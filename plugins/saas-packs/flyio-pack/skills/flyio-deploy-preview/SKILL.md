---
name: flyio-deploy-preview
description: |
  Execute Fly.io primary workflow: Deploy & Preview.
  Use when deploying a preview for every pull request,
  promoting staging to production, or rolling back a bad deployment.
  Trigger with phrases like "flyio deploy",
  "deploy application with flyio".
...
## Next Steps
For secondary workflow, see `flyio-build-configure`.