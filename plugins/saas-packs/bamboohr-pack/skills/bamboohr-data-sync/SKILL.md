---
name: bamboohr-data-sync
description: |
  Execute BambooHR secondary workflow: Integration & Data Sync.
  Use when syncing records between systems on a schedule,
  or building real-time event-driven integrations.
  Trigger with phrases like "bamboohr sync data",
  "sync between systems with bamboohr".
...
# BambooHR Integration & Data Sync
...
- Familiarity with `bamboohr-entity-management`
