---
name: bamboohr-entity-management
description: |
  Execute BambooHR primary workflow: Domain Entity Management.
  ...
  Trigger with phrases like "bamboohr manage entities",
  "create or update domain entities with bamboohr".
...
# BambooHR Domain Entity Management
...
## Next Steps
For secondary workflow, see `bamboohr-data-sync`.