---
name: stackblitz-build-configure
description: |
  Execute StackBlitz secondary workflow: Build & Configure.
  Use when setting environment variables for different stages,
  or configuring build commands and output directories.
  Trigger with phrases like "stackblitz configure",
  "configure project with stackblitz".
...
- Familiarity with `stackblitz-deploy-preview`
