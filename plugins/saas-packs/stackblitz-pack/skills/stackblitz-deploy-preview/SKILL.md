---
name: stackblitz-deploy-preview
description: |
  Execute StackBlitz primary workflow: Deploy & Preview.
  Use when deploying a preview for every pull request,
  promoting staging to production, or rolling back a bad deployment.
  Trigger with phrases like "stackblitz deploy",
  "deploy application with stackblitz".
...
## Next Steps
For secondary workflow, see `stackblitz-build-configure`.