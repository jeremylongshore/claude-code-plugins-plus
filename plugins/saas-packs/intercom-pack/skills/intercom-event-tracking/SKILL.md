---
name: intercom-event-tracking
description: |
  Execute Intercom secondary workflow: Event Tracking & Segmentation.
  Use when tracking product usage events to trigger messages,
  or building behavioral segments for campaign targeting.
  Trigger with phrases like "intercom track events",
  "track user events with intercom".
...
# Intercom Event Tracking & Segmentation
...
- Familiarity with `intercom-campaign-delivery`
