---
name: intercom-campaign-delivery
description: |
  Execute Intercom primary workflow: Campaign & Message Delivery.
  ...
  Trigger with phrases like "intercom send campaign",
  "create and send campaign with intercom".
...
# Intercom Campaign & Message Delivery
...
## Next Steps
For secondary workflow, see `intercom-event-tracking`.