---
name: twinmind-model-inference
description: |
  Execute TwinMind primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "twinmind inference",
  "run model inference with twinmind".
...
# TwinMind Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `twinmind-embeddings-search`.