---
name: klaviyo-campaign-delivery
description: |
  Execute Klaviyo primary workflow: Campaign & Message Delivery.
  ...
  Trigger with phrases like "klaviyo send campaign",
  "create and send campaign with klaviyo".
...
# Klaviyo Campaign & Message Delivery
...
## Next Steps
For secondary workflow, see `klaviyo-event-tracking`.