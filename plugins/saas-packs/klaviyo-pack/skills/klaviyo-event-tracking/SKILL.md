---
name: klaviyo-event-tracking
description: |
  Execute Klaviyo secondary workflow: Event Tracking & Segmentation.
  Use when tracking product usage events to trigger messages,
  or building behavioral segments for campaign targeting.
  Trigger with phrases like "klaviyo track events",
  "track user events with klaviyo".
...
# Klaviyo Event Tracking & Segmentation
...
- Familiarity with `klaviyo-campaign-delivery`
