---
name: juicebox-contact-sync
description: |
  Execute Juicebox primary workflow: Contact Sync & Enrichment.
  ...
  Trigger with phrases like "juicebox sync contacts",
  "import and enrich contacts with juicebox".
...
# Juicebox Contact Sync & Enrichment
...
- Access to contacts/deals data in your Juicebox instance
...
## Next Steps
For secondary workflow, see `juicebox-deal-pipeline`.