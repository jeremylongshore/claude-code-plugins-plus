---
name: apollo-contact-sync
description: |
  Execute Apollo primary workflow: Contact Sync & Enrichment.
  ...
  Trigger with phrases like "apollo sync contacts",
  "import and enrich contacts with apollo".
...
# Apollo Contact Sync & Enrichment
...
- Access to contacts/deals data in your Apollo instance
...
## Next Steps
For secondary workflow, see `apollo-deal-pipeline`.