...
description: |
  Execute LangChain primary workflow: Model Inference Pipeline.
  ...
  Trigger with phrases like "langchain inference",
  "run model inference with langchain".
...
# LangChain Model Inference Pipeline
...
## Next Steps
For secondary workflow, see `langchain-embeddings-search`.