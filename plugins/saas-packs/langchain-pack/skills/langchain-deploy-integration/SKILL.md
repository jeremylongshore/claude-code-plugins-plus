...
description: |
  Deploy LangChain integrations to production platforms.
  Use when deploying LangChain-powered applications to production,
  configuring platform-specific secrets, or setting up deployment pipelines.
  Trigger with phrases like "deploy langchain", "langchain production",
  "langchain production deploy", "langchain CI/CD".
...
Deploy LangChain-powered applications as stateless API wrappers — serverless functions
that receive user requests, call the LangChain model API, and stream responses back.
