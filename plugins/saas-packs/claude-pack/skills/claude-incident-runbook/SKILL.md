...
|-------|-------|----------|
| API Error | Check error type and status code | See `claude-common-errors` |
...
## Next Steps
See `claude-reliability-patterns` for building resilient integrations.

## Prerequisites
- Production Claude integration deployed
- Fallback model configuration in place (see `claude-reliability-patterns`)
- Monitoring/alerting configured (see `claude-observability`)
