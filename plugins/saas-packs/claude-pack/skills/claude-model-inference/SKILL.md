...
## Prerequisites
- Completed `claude-install-auth`
- Familiarity with `claude-hello-world`
...
| `rate_limit_error` (429) | Exceeded RPM or TPM | Check `retry-after` header. See `claude-rate-limits` |
...
## Next Steps
See `claude-embeddings-search` for tool use and function calling patterns.
