---
name: ramp-transaction-processing
description: |
  Execute Ramp primary workflow: Transaction Processing.
  ...
  Trigger with phrases like "ramp process transaction",
  "create and track transactions with ramp".
...
## Next Steps
For secondary workflow, see `ramp-reporting-compliance`.