...
description: |
  Execute Salesforce primary workflow: Contact Sync & Enrichment.
  ...
  Trigger with phrases like "salesforce sync contacts",
  "import and enrich contacts with salesforce".
...
# Salesforce Contact Sync & Enrichment
...
- Access to contacts/deals data in your Salesforce instance
...
## Next Steps
For secondary workflow, see `salesforce-deal-pipeline`.