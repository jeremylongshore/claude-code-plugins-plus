---
name: alchemy-reporting-compliance
description: |
  Execute Alchemy secondary workflow: Reporting & Compliance.
  Use when generating monthly expense reports for accounting,
  or producing audit trails for compliance reviews.
  Trigger with phrases like "alchemy financial report",
  "generate compliance report with alchemy".
...
- Familiarity with `alchemy-transaction-processing`
