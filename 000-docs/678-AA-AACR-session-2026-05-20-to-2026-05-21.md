...
| Repo                          | PR  | What                                                                                                                                                                                                                                                                                                                                                                                                             |
| ----------------------------- | --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `intentsolutions-vps-runbook` | #22 | `docs(caddy): wire access logging for redirect domains` — added `log` directive to the Caddyfile redirect block on the VPS so `tonsofskills.com` / `claudecodeskills.io` / `claudecoworkskills.io` hits land in `/var/log/caddy/redirects-access.log`. Live-applied + verified. Gotcha doc: pre-create the log file `caddy:caddy 600` ownership before reload, or systemctl gets stuck in `reloading` state. |
