...
| 21  | Retired legacy public domain                                                   | **356 case-insensitive occurrences across 125 tracked files** at `3543d5d167bd4e8d27666c8893080bca3bd72950`: 293 actionable (261 first-party + 32 generated) and 63 retained (3 frozen + 60 point-in-time export + 0 provenance mirrors)                                                                                                                                                | 0 actionable; the 63 retained occurrences remain byte-identical and enumerated                    |
...
| 1.13 | **STILL REQUIRED**                      | Row 21 correction: 356 case-insensitive occurrences across 125 files at `3543d5d167bd4e8d27666c8893080bca3bd72950`; 293 actionable and 63 retained by machine-readable class                                                                                                                                     |
...
**Measurable outcome.** Catalog entries 471 → 467 with a uniqueness assertion · tracked stale catalog shadow 1 → 0 · counterfeit assets 12 → 0 with a magic-byte gate · tracked generated artifacts without a drift gate 6 → 0 · README metric writers 2 → 1 · published answers to "how many skills" 5 → 1 resolver with 5 named cohorts · `sources.yaml`/lock keys 64/63 → equal · retired-domain occurrences 293 actionable → 0, with 63 classified historical occurrences retained byte-identically.

**E1.13 measurement correction (2026-08-16).** The earlier 341/121 headline used a case-sensitive grep and treated all non-6767 files as one population. At exact base `3543d5d167bd4e8d27666c8893080bca3bd72950`, `git grep -I -i -o "$(printf '%s%s' claudecode plugins.io)" <SHA> -- | wc -l` reports 356 occurrences and the corresponding `-l` command reports 125 files. Running `node scripts/check-dead-domain.mjs --json --root <clean-checkout-of-SHA>` separates 293 actionable occurrences (261 editable first-party + 32 registered generated projections) from 63 retained occurrences (3 in frozen 6767-h + 60 in the registered Freshie run-1 snapshot + 0 provenance mirrors). These populations are not interchangeable. The gate targets zero actionable occurrences and requires every retained class to remain byte-identical.
...
| 1.13 | Replace the dead public domain in first-party surfaces and block its reintroduction.                                    | task · P2               | 293 actionable occurrences replaced across **non-frozen first-party sources and their registered generated projections**; 63 frozen or point-in-time occurrences and every mirror occurrence left byte-identical and enumerated; a case-insensitive, fail-closed lint rule blocks reintroduction.                                                                                                            |
...
| 57  | 356 case-insensitive retired-domain occurrences: 293 actionable, 63 retained                         | 1 / 8     | 1.13 / 8.14                                                         | P2  |
