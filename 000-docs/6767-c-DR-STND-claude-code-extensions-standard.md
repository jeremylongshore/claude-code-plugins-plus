> **SUPERSEDED–FROZEN (Epic 2 bead 2.1; 2026-08-15).** This historical standard is retained for citation and anchor compatibility; it is not authoritative. The governing platform standard is [727](727-AT-ARCH-master-modernization-blueprint.md). Its enterprise-only rules and legacy schema assumptions are superseded by the ratified modernization blueprint. Do not edit below this banner; preserve the body and section anchors byte-for-byte.
