...
| Reproduction first      | PASS   | On base and head, run `PATH=/nonexistent /usr/bin/node scripts/check-changelog-coverage.mjs`: base exits 0 with “git tags unavailable — skipping”; head exits 1 with `REFUSED`.                                                                                                                                                                                                                                                                                            |
