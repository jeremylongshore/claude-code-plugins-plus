...
[`@intentsolutions/core@0.9.0`](https://www.npmjs.com/package/@intentsolutions/core)
under `schemas/authoring/v1/` (the `authoring/v1` family is byte-frozen across
kernel package versions, so this mapping holds identically at any pinned version;
the citation tracks the current CCPI pin). This documents where prose ↔ machine agree, and
