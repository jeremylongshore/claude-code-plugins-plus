...
[![Skills](https://img.shields.io/badge/skills-3071-green)](https://tonsofskills.com/skills)
...
| 3,071 | marketplace-visible skills (distinct)  | `node -e "import('./scripts/corpus-resolver.mjs').then(m=>console.log(m.resolveCorpus('marketplace-visible').length))"` |
