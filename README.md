...
[![Skills](https://img.shields.io/badge/skills-3017-green)](https://tonsofskills.com/skills)
...
| 3,017 | marketplace-visible skills (distinct)  | `node -e "import('./scripts/corpus-resolver.mjs').then(m=>console.log(m.resolveCorpus('marketplace-visible').length))"` |
