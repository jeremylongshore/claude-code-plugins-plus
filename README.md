...
[![Skills](https://img.shields.io/badge/skills-3061-green)](https://tonsofskills.com/skills)
...
| 3,061 | marketplace-visible skills (distinct)  | `node -e "import('./scripts/corpus-resolver.mjs').then(m=>console.log(m.resolveCorpus('marketplace-visible').length))"` |
