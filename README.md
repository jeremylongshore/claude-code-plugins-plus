...
[![Plugins](https://img.shields.io/badge/plugins-444-blue)](https://tonsofskills.com/explore)
[![Skills](https://img.shields.io/badge/skills-3085-green)](https://tonsofskills.com/skills)
...
| ----: | -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
|   444 | catalog plugins (catalog-entry cohort) | `node scripts/generate-readme-toc.mjs` over `marketplace.extended.json`                                                 |
| 3,085 | marketplace-visible skills (distinct)  | `node -e "import('./scripts/corpus-resolver.mjs').then(m=>console.log(m.resolveCorpus('marketplace-visible').length))"` |
